...
router.get("/detail/:inventoryId", utilities.handleErrors(inventoryController.buildSingleView));

// Route for adding a review
router.post("/review/:inventoryId", utilities.handleErrors(inventoryController.addReview));
...
router.get("/", utilities.checkAdminEmployee, utilities.handleErrors(inventoryController.buildManagementView));
...
router.get("/edit/:inventoryId", utilities.handleErrors(inventoryController.buildEditInventoryView));


// Route for new classification
router.get("/addClassification", utilities.checkAdminEmployee, utilities.handleErrors(inventoryController.buildClassificationView));
...
router.get("/addInventory", utilities.checkAdminEmployee, utilities.handleErrors(inventoryController.buildInventoryView));
...
// Route for editing inventory
router.get("/edit/:inventoryId", utilities.checkAdminEmployee, utilities.handleErrors(inventoryController.buildEditInventoryView));
...
router.get("/delete/:inventoryId", utilities.checkAdminEmployee, utilities.handleErrors(inventoryController.buildDeleteInventoryView))
