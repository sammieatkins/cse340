...
(
	...
	inventory_year character(4) NOT NULL,
...
(
    ...
    CONSTRAINT fk_review_inventory FOREIGN KEY (inventory_id) REFERENCES public.inventory(inventory_id),
    CONSTRAINT fk_review_account FOREIGN KEY (account_id) REFERENCES public.account(account_id)
);
